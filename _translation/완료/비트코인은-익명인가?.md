...
얼마 전에 봉급이 인상된 사람의 좀 더 구체적인 예를 들어보자. 그들은 집주인이 그것을 알게 되기를 원하지 않을 수도 있는데, 이 집주인은 그것을 임대료를 올릴 좋은 기회로 볼 수도 있기 때문이다. 동성애자는 아무도 모르게 게이 포르노에 돈을 지불하고 싶어할 수 있는데, 특히 게이가 범죄로 취급되는 정권에서 그렇다. 반체제 가명 언론인은 그의 나라에서 정권이 그가 누구인지 알아내지 않고 그의 기사에 대한 대가를 받기를 원할지도 모른다. 보수적인 가정의 한 십대 소녀는 그녀의 부모님 몰래 피임을 구입하고 싶어할지도 모른다. 공화당의 한 마을에 사는 민주당원은 이웃들의 분노를 사지 않고 자신이 좋아하는 정치인에게 돈을 기부하고 싶어할지도 모른다. 부유한 비트코인은 그가 납치, 강탈, 또는 더 나쁜 범죄의 표적이 될 것이기 때문에 그의 보유 재산을 공개하기를 원하지 않을 수도 있다. 등등.
